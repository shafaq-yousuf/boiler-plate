...
let fbCustomPost = (nodeName, obj) => {
    return new Promise((resolve, reject) => {
        ...
        set(Reference, obj).then((res)=>{resolve('send')}).catch((err)=>{reject(err.message)})
    })
}
let fbGet = (nodeName)=>{
    return new Promise((resolve, reject) => {
...
export { UserSignup, userLogin, checkAuth, getFBdata, userLogOut, postFBdata, fbCustomPost, fbGet };