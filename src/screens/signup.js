            ...
            <div className="container py-3">
                ...
                <div className="row">
                    <div className="col-md-6 py-3">
                        <input onChange={(e) => setModel({ ...model, name: e.target.value })} type="name" name="name" id="name" placeholder="Name" className="rounded p-2 w-75 my-1" />
                        ...
                        <input onChange={(e) => setModel({ ...model, password: e.target.value })} type="password" name="password" id="password" placeholder="Password"
